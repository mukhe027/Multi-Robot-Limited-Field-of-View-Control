...
h(1) = plot(xy1(:,1), xy1(:,2),'LineStyle','--','LineWidth',3,'Color', 'b');
hold on
h(2) = plot(xy2(:,1), xy2(:,2),'LineStyle','--','LineWidth',3,'Color', 'r');
h(3) = plot(xy3(:,1), xy3(:,2),'LineStyle','--','LineWidth',3,'Color', 'r');